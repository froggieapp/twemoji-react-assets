...
const Svg1F9D81F3Fe200D2640Fe0F = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" width="1em" height="1em" {...props}>
    ...
    <path fill="#60352A" d="M19 0a5.964 5.964 0 0 0-3.402 1.061C15.402 1.031 15.205 1 15 1a4 4 0 0 0-4 4v4a7 7 0 1 0 14 0V6.001A6 6 0 0 0 19 0"/>
    ...
    <path fill="#AF7E57" d="M16 11v4a2 2 0 0 0 4 0v-4z"/>
    <path fill="#9B6A49" d="m20 11-4 .019V15s2 1 4 0z"/>
    <path fill="#AF7E57" d="M16 3s-.011 3.285-3 3.894V9c0 2.762 2.238 5 5 5s5-2.237 5-5V6.968C16.019 6.644 16 3 16 3"/>
    <path fill="#DF1F32" d="M20 12h-4s0 1 2 1 2-1 2-1"/>
    <path fill="#915A34" d="M16.25 8.75h-1.5c-.137 0-.25-.113-.25-.25s.113-.25.25-.25h1.5c.138 0 .25.113.25.25s-.112.25-.25.25m5 0h-1.5c-.138 0-.25-.113-.25-.25s.112-.25.25-.25h1.5c.138 0 .25.113.25.25s-.112.25-.25.25M17 10h2s0 1-1 1-1-1-1-1"/>
  </svg>);
exports.default = Svg1F9D81F3Fe200D2640Fe0F;
