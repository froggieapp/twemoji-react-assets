...
const Svg1F384 = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" width="1em" height="1em" {...props}>
    <path fill="#662113" d="M22.088 32.83c0 1.997-1.619 2.712-3.616 2.712s-3.616-.715-3.616-2.712l.904-8.136c0-1.996.715-1.808 2.712-1.808 1.997 0 2.712-.188 2.712 1.808z"/>
    ...
    <path fill="#3E721D" d="M23.301 8.911C20.983 6.925 19.68 4.08 18.472 4.08c-1.207 0-2.511 2.845-4.83 4.831-1.843 1.579 2.415 1.933 4.83 0 2.414 1.933 6.673 1.579 4.829 0"/>
    <path fill="#5C913B" d="M23.301 7.832C20.983 5.845 19.68 3 18.472 3c-1.207 0-2.511 2.845-4.83 4.832-1.843 1.579 2.415 1.933 4.83 0 2.414 1.932 6.673 1.578 4.829 0"/>
