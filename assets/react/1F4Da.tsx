...
const Svg1F4Da = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#99AAB5"
      d="M8 5h23.925c-.114-1.125-.364-2-.753-2H8C6.807 3 6.331 5.489 6.562 7.5 6.718 6.142 7.193 5 8 5"
    />
    <path
      fill="#F4900C"
    ...
    <path
      fill="#99AAB5"
      d="M16 16h19.984c-.065-1.062-.334-2-.812-2H16c-1.274 0-1.733 2.027-1.383 3.5.198-.839.657-1.5 1.383-1.5"
    />
  </svg>
);
export default Svg1F4Da;
