...
const Svg1Faf61F3Fe = (props) => (<svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" viewBox="0 0 36 36" width="1em" height="1em" {...props}>
    ...
    <path fill="#9B6A49" d="M4.445 25.331c-1.571-1.3-2.176-.836-3.179-2.419-.085-.13-1.06-2.083-1.266-2.142V28l1.967-1.475c.636-.477 1.532-.91 2.479-1.193zm30.289-2.419c-1.003 1.583-1.608 1.119-3.18 2.42.948.283 1.843.716 2.479 1.193L36 28v-7.23c-.206.059-1.181 2.012-1.266 2.142"/>
  </svg>);
exports.default = Svg1Faf61F3Fe;
