...
const Svg1F5Fd = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" width="1em" height="1em" {...props}>
    <path fill="#88C9F9" d="M36 32a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4V4a4 4 0 0 1 4-4h28a4 4 0 0 1 4 4z"/>
    <path fill="#157569" d="M26.496 9.174 32 0h-2l-6.38 7.292a12.885 12.885 0 0 0-3.741-1.141L19 0h-2l-.879 6.151a12.857 12.857 0 0 0-3.676 1.109L7 0H5l4.561 9.123a13.061 13.061 0 0 0-2.38 2.673L0 10v2l5.819 2.494A12.93 12.93 0 0 0 5 19c-.001.098-.013.191-.017.288l-2.748.393c-.078-.225-.156-.444-.235-.681-1-2.999-2-5-2-5v18c0 4 4 4 4 4h28s-.465-1.044 0-2c.179-.368 1.447-.658 1-2-.709-2.129-1.417-6.767-1.769-10H36v-2l-4.992-.713A7.902 7.902 0 0 1 31 19c0-1.587-.299-3.1-.818-4.506L36 12v-2l-7.182 1.796a13.037 13.037 0 0 0-2.322-2.622M4 24s-.372-.747-.886-2h1.483C4.319 23.181 4 24 4 24"/>
    <path fill="#3FC9B9" d="M7 18s.422-3.316 4-6c4-3 6-2 6-1s-3 1-6 3-4 4-4 4m22 0s-.423-3.316-4-6c-4-3-6-2.001-6-1 0 1 3 1 6 3s4 4 4 4m-11-4c-6 0-8 4-8 4s2-2 4-2 2 2 2 2v2c0 1 2 1 2 1s2 0 2-1v-2s0-2 2-2 4 2 4 2-2-4-8-4"/>
