...
const Svg1F49D = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path fill="#FDD888" d="M36 15c-1 5-4 8-4 8H4s-3-3-4-8z" />
    <path fill="#FDD888" d="M14 18v18l-5-5-5 5V18z" />
    <path
      fill="#FDCB58"
      d="m16.802 9.194-7.879 5.515-7.878-5.515C.47 8.792 0 9.036 0 9.738v14.658c0 .703.48.965 1.069.582l7.854-5.106 7.854 5.106c.588.383 1.069.121 1.069-.582V9.738c.001-.702-.47-.946-1.044-.544"
    />
