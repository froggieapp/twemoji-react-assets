...
const Svg1F40A = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="#3E721D"
      d="M19 32c0 1-1.723 3-3.334 3C14.056 35 14 33.657 14 32s1.306-3 2.916-3C18.527 29 19 30.343 19 32m11 0c0 1-1.723 3-3.334 3C25.056 35 25 33.657 25 32s1.306-3 2.916-3C29.527 29 30 30.343 30 32"
    />
    <path
      fill="#5C913B"
    ...
    <path
      fill="#292F33"
      d="M10 18.123a1.5 1.5 0 1 0 3 0c0-.829-.671 0-1.5 0s-1.5-.829-1.5 0"
    />
    <g fill="#77B255">
    ...
    <path
      fill="#FFF"
      d="M6 22c-.389 0-1-1-1-1h2s-.611 1-1 1m-2 .469C3.611 22.469 3 21 3 21h2s-.611 1.469-1 1.469M2 23c-.389 0-1-2-1-2h2s-.611 2-1 2"
    />
  </svg>
);
