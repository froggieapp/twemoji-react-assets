...
const Svg1F984 = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" width="1em" height="1em" {...props}>
    ...
    <path fill="#C1CDD5" d="M13.789 3.662c.573.788 3.236.794 4.596 3.82 1.359 3.026-1.943 2.63-3.14 1.23-1.334-1.561-1.931-2.863-2.165-3.992-.124-.596-.451-2.649.709-1.058"/>
    ...
    <circle cx={15.255} cy={14.565} r={0.946} fill="#292F33"/>
    <path fill="#53626C" d="M8.63 26.877c.119.658-.181 1.263-.67 1.351-.49.089-.984-.372-1.104-1.03-.119-.659.182-1.265.671-1.354.49-.088.984.373 1.103 1.033"/>
    <path fill="#EE7C0E" d="m13.844 8.124.003-.002-.005-.007-.016-.014c-.008-.007-.011-.019-.019-.025-.009-.007-.021-.011-.031-.018C12.621 7.078.933-.495.219.219-.51.948 10.443 9.742 11.149 10.28l.011.006.541.439c.008.007.01.018.018.024.013.01.028.015.042.024l.047.038-.009-.016c.565.361 1.427.114 1.979-.592.559-.715.577-1.625.066-2.079"/>
    <path fill="#C43512" d="m4.677 2.25.009-.025a73.606 73.606 0 0 0-.878-.5c-.016.038-.022.069-.041.11a4.015 4.015 0 0 1-.429.716 3.936 3.936 0 0 1-.541.595c-.02.018-.036.026-.056.043.238.22.489.446.745.676A5.006 5.006 0 0 0 4.677 2.25m2.275 2.945c.306-.41.521-.822.66-1.212-.292-.181-.584-.36-.876-.538-.076.298-.247.699-.586 1.152a3.45 3.45 0 0 1-.864.845c.259.223.52.445.779.665.314-.244.619-.552.887-.912M9.87 7.32c.365-.49.609-.983.734-1.437l-.906-.586c-.023.296-.172.81-.631 1.425-.412.554-.821.847-1.1.978l.814.671A4.535 4.535 0 0 0 9.87 7.32"/>
  </svg>);
exports.default = Svg1F984;
