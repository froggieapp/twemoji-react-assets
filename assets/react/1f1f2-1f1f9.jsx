...
const Svg1F1F21F1F9 = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" width="1em" height="1em" {...props}>
    <path fill="#CF142B" d="M32 5H18v26h14a4 4 0 0 0 4-4V9a4 4 0 0 0-4-4"/>
    <path fill="#EEE" d="M4 5a4 4 0 0 0-4 4v18a4 4 0 0 0 4 4h14V5z"/>
    <path fill="#CF142B" d="M1.654 9.656h8.691v2.688H1.654z"/>
    <path fill="#CF142B" d="M4.656 6.654h2.688v8.691H4.656z"/>
    <g fill="#CF142B">
      <circle cx={4.71} cy={12.271} r={0.921}/>
      <circle cx={7.355} cy={12.271} r={0.921}/>
      <circle cx={4.71} cy={9.824} r={0.921}/>
      <circle cx={7.355} cy={9.824} r={0.921}/>
    </g>
    <g fill="#99AAB5">
      <circle cx={4.708} cy={12.271} r={0.708}/>
      <circle cx={7.355} cy={12.271} r={0.708}/>
      <circle cx={4.708} cy={9.824} r={0.708}/>
      <circle cx={7.355} cy={9.824} r={0.708}/>
    </g>
