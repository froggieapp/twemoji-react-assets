...
const Svg1F9D11F3Fe200D1F9Af = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" width="1em" height="1em" {...props}>
    ...
    <path fill="#AF7E57" d="M21.001 1.418c-1.616-.481-3.893.53-4.11 2.372-.303 2.57 1.323 4.585 2.901 4.276 1.654-.324 2.648-.782 3.177-2.559.528-1.777-.353-3.608-1.968-4.089"/>
    <path fill="#AF7E57" d="M22.562 5.988c2.045-2.867-3.411-2.136-3.411-2.136-1.034.127-.172 1.793-.579 2.778-.279.682 1.16.907 1.16.907s.646-.065.748.716v.007c.025.199.024.438-.042.763-.329 1.61 1.862 2.392 2.19.779.13-.638.012-1.18-.124-1.677l-.012-.045c-.205-.74-.436-1.383.07-2.092"/>
    <path fill="#60352A" d="M23.013 1.791c-.861-.977-3.527-1.676-5.056-.215-1.154-.1-1.497 1.019-1.347 1.633.12.49 1.352.514 1.739 1.431.193-.255.207-.744.139-.999.421.341.336 1.339 1.92 1.85 1.532.494 1.382 1.822 1.382 1.822s.747-.435 1.235-1.109c.934-1.286.937-3.336-.012-4.413"/>
    ...
    <path fill="#AF7E57" d="M20.029 11.693c-.781 1.172-2.291 3.808-2.518 3.909-1.205.534-2.549 1.22-3.445 1.314-.649.068-1.254.68-1.508.925-.316.304-.75 1.008-.63 1.37.075.226.571.488.742.253.332-.458.973-.535 1.49-.889 1.038-.712 3.284-.765 4.556-1.709.528-.391 1.677-1.309 3.2-3.9-.592-.426-1.887-1.273-1.887-1.273"/>
...
exports.default = Svg1F9D11F3Fe200D1F9Af;
