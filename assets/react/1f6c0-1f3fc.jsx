...
const Svg1F6C01F3Fc = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" width="1em" height="1em" {...props}>
    <path fill="#F3D2A2" d="M11 17c1 3 .209 5-2 5s-5.012-2.024-6-4c-1-2 .904-4.301 3-5 3-1 4.368 2.102 5 4"/>
    <path fill="#FFE51E" d="M9 13c0-1-3-2-6 1s1.021 5 1.021 5S8 22 7 19s2-5.001 2-6"/>
