...
const Svg1F4Bb = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#9AAAB4"
      d="m.008 34.075.006.057.17.692A1.998 1.998 0 0 0 2 36h32a2 2 0 0 0 1.992-1.925z"
    />
    <path
      fill="#5DADEC"
    ...
    <path
      fill="#9AAAB4"
      d="M22.375 33.113h-7.781c-.375 0-.538-.343-.484-.675.054-.331.359-1.793.383-1.963.023-.171.274-.375.524-.375h7.015c.297 0 .49.163.55.489.059.327.302 1.641.321 1.941.019.301-.169.583-.528.583"
    />
  </svg>
);
