...
const Svg1F396 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#FFAC33"
      d="M20.731 32.36a.58.58 0 0 1-.339-.109L18 30.535l-2.393 1.716a.58.58 0 0 1-.892-.647l.892-2.88-2.371-1.671a.582.582 0 0 1 .341-1.049L16.514 26l.935-2.809a.58.58 0 0 1 1.102 0L19.47 26l2.952.004a.58.58 0 0 1 .341 1.049l-2.371 1.671.892 2.88a.58.58 0 0 1-.553.756"
    />
  </svg>
);
export default Svg1F396;
