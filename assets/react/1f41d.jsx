...
const Svg1F41D = (props) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" width="1em" height="1em" {...props}>
    ...
    <path fill="#FFCC4D" d="M14.624 19h6.752c-1.462-1.424-2.615-2.881-3.106-4h-.54c-.491 1.119-1.644 2.576-3.106 4m-5.378 4c-.361.187-.715.349-1.062.488.32 1.219.799 2.407 1.401 3.512h16.83a15.677 15.677 0 0 0 1.401-3.512A12.206 12.206 0 0 1 26.753 23zm3.593 8c1.518 1.234 3.278 2 5.161 2 1.884 0 3.643-.766 5.162-2z"/>
    <path fill="#CCD6DD" d="M18 13.505c0 2.647-7.858 8.584-12 8.584s-6-2.443-6-5.09c0-2.646 1.858-4.495 6-4.495 4.143.001 12-1.644 12 1.001m0 0c0 2.647 7.857 8.584 12 8.584s6-2.443 6-5.09c0-2.646-1.857-4.495-6-4.495s-12-1.644-12 1.001"/>
    <path fill="#99AAB5" d="M2 19a1 1 0 0 1-.002-2c.048 0 4.949-.07 13.596-3.914a1 1 0 1 1 .813 1.827C7.317 18.953 2.213 19 2 19m32 0c-.213 0-5.316-.047-14.406-4.086a1 1 0 0 1 .812-1.827C29.054 16.93 33.954 17 34.003 17A1 1 0 0 1 34 19"/>
  </svg>);
